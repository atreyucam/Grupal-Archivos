...
{
    public partial class FormBusquedaEliminarProducto : Form
    {
        int posicion;

        public FormBusquedaEliminarProducto()
        {
            InitializeComponent();
        ...
        private void buttonBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (data.Length > 0)
            {
                ...
                mostrarProducto.setLabelButton("Eliminar");
                ...
                if (mostrarProducto.ShowDialog() == DialogResult.OK)
                {
                    data[0].Delete();
